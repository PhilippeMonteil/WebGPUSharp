...
rmdir /S /Q out\android-x86_64

cmake -S . -B out\android-x86_64 -G Ninja ^
...
cmake --build out\android-x86_64

pause
d:
cd D:\Repos\dawn\out\android-x86_64\src\dawn\native
dir libwebgpu_dawn.so
llvm-strip --strip-all D:\Repos\dawn\out\android-x86_64\src\dawn\native\libwebgpu_dawn.so -o D:\Repos\dawn\out\android-x86_64\src\dawn\native\webgpu_dawn.so
dir webgpu_dawn.so
cd D:\Repos\dawn
pause
